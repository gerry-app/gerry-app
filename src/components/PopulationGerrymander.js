...
class PopulationGerrymander extends React.PureComponent {
  constructor(props) {
    super(props);
    let districts = {};
  ...
  render() {
    ...
    return (
      <div className={classes.PopulationGerrymander}>
...
export default injectSheet(styles)(PopulationGerrymander);
